<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;color:#333" border>
			...
			<el-table-column prop="birth" label="用户名" width="100" sortable>
				<template slot-scope="scope">{{ scope.row.username}}</template>	
			</el-table-column>
			<el-table-column prop="birth" label="base32" width="400" sortable>
				<template slot-scope="scope">{{ scope.row.base32}}</template>	
			</el-table-column>
				<el-table-column prop="birth" label="状态" width="220" sortable>
				<template slot-scope="scope">{{ scope.row.status}}</template>	
			</el-table-column>
				<el-table-column prop="birth" label="登录时间" width="220" sortable>
  ...
  methods: {
    ...
    getUsers() {
      ...
      getUserListPage(para).then(res => {
        ...
        //this.users=this.users.push(this.editForm.password);
